...
define ( "DATABASE", "tattletale" );				// - database name - the name of your mysql database
define ( "DBUSER", "root" );				// - database user - what user should we use to access the database
define ( "DBPASS", "gsfrb_i969" );			// - database password - what password should we use to access the database
define ( "DBPREFIX", "" );				// - db prefix - would you like to use a prefix for your table?
define ( "APPLICATION_URL", "http://phil.cryer.us/code/tattletale/demos/login/" );// - app. url - the url that points to our application ( ! with trailing slash )
...
define ( "ADMIN_EMAIL", "admin@cryer.us" );	// - what email should we use to contact our members?
...
define ( "DOMAIN_NAME", "tattletale demo" );		// - the domain name that we use
